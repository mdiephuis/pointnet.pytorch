...
def AddGaussianNoise(pointcloud, sigma = 0.1, percent_points = 0.2):
    ...
    noisypointcloud = pointcloud * ((nums*noise)+(np.ones([N,D]))) # multiply the point cloud by noise vector
